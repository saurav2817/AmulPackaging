 ...
 * Spreadsheet: https://docs.google.com/spreadsheets/d/1bvMV5e2jUIRL5oNPcnIvUv97jK9mMrV8rY8F7LridTw/edit?gid=0#gid=0
 * 
 * Columns mapped:
...
function doPost(e) {
  ...
  try {
    ...
    var sheet = doc.getSheets()[0]; // First sheet (gid=0)
    ...
    // Extract fields with fallbacks for alternative casing/naming
    var name = data.name || data.names || "";
    var phone = data.phone || data.Phone || data["Phone "] || "";
    var email = data.email || data["email-id"] || data.emailId || "";
