const products = [
  {
    ...
    //     },
    //     {
    //       name: "Foil laminated film",
    //       icon: "🥫"
    //     },
    //     {
    //       name: "High-barrier film",
    //       icon: "�"
    //     },
    //     {
    //       name: "Recyclable & eco-friendly options",
    //       icon: "🌱"
    //     }
    //   ],
    //   Note:
  ...
  },
  {
    ...
    Details:
      ...
      KeyFeatures: [
        ...
        "Durable laminated film construction",
        "Tear-notch and zip-lock options",
        "Glossy, matte, kraft or transparent finishes",
        "Custom printing with high-clarity visuals",
        "Food-grade and safe materials"
      ],
      Conclusion:
        "You can customise size, thickness, finish, colors, and printing style as per your product requirements."
    },
    Applications: [
    ...
    },
    {
      ...
      Points: [
        ...
        "Secure sealing and strong film structure",
        "Full printing support",
        "Fast delivery timelines",
        "Bulk order capability",
        "Consistent pouch quality",
        "Good shelf appeal and branding space",
        "Trusted by multiple industries"
      ],
      ClosingLine:
        "We help you pack your product safely and professionally."
    },
    FAQs: [
      {
        question: "What is a three side seal pouch?",
      ...
      {
        question: "Do you offer sample packs for testing?",
        answer: "Yes, samples can be provided before bulk production."
      },
      {
  ...
  },
  {
    ...
    About: {
      Title: "Flat Bottom Pouch – Premium Packaging With Strong Shelf Appeal",
      Description:
      ...
      KeyFeatures: [
        ...
        "High barrier against oxygen, moisture, and odor loss",
        "Available in matte, glossy, kraft, window, and transparent styles",
        "Multiple closure options — zipper, valve, tin-tie",
        "Custom size and thickness based on product weight",
        "Tear-notch options for consumer ease",
        "Food-grade safe material",
        "Good for automated filling lines"
      ],
      Conclusion:
   ...
   FAQs: [
      ...
      },
      {
        ...
        answer: "Yes, samples can be arranged based on requirement."
      },
      {
        question: "Can I get recyclable options?",
        answer: "Yes, we provide eco-friendly pouch material options."
      },
      {
...
HeroText:"Our high-quality Centre Seal Pouches ensure airtight protection, optimal shelf life, and a polished look — perfect for a wide range of applications.",
    Details:
      ...
      KeyFeatures: [
        ...
        "Ideal for powders, granules, snacks, and FMCG items",
        "Lightweight and easy to transport",
        "Saves storage space",
        "Works well for single-serve and bulk packs",
        "Easily printable for branding",
        "Budget-friendly for startups and established brands"
      ],
      Conclusion:
...
"Industry": [
   ...
   FAQs: [
      ...
      {
        question: "Do you supply small sachet packaging?",
        answer: "Yes, we manufacture small and large sealed pouches."
      },
      {
        question: "Can I get recyclable pouch material?",
        answer: "Yes, sustainable options are available on request."
      },
      {
        question: "Do you offer wholesale pricing?",
...
HeroText:"With reinforced side seals and a durable design, our Quad Seal Pouches provide exceptional barrier protection and a commanding presence on display.",
    ...
    About: {
      Title: "Quad Seal Pouch – Strong, Stable and Premium Packaging for Heavy Products",
      Description:
  ...
  },
  {
    ...
    items: [
      ...
      Points: [
        ...
        "Export-grade laminate films",
        "Durable and leak-proof structure",
        "High-quality printing and finishing",
        "Fast production and delivery",
        "Custom shapes and sizes",
        "Wholesale and bulk supply",
        "Food-safe film and inks"
      ],
      ClosingLine:
   ...
   FAQs: [
      ...
      {
        question: "Are these pouches food-safe?",
        answer: "Yes, all laminates and inks used are food-grade."
      },
      {
        question: "Do quad seal bags offer more branding space?",
        answer: "Yes, four panels allow for more design and information."
      },
      {
...
HeroText:"Our high-barrier Vacuum Pouches remove excess air and moisture, ensuring maximum protection and freshness for food and non-food items alike.",
    ...
    About: {
      Title: "Vacuum Pouch – High-Barrier Packaging for Maximum Freshness & Protection",
      Description:
  ...
  ClosingLine:
   ...
   FAQs: [
      ...
      },
      {
        ...
        answer: "Yes, we provide wholesale and large-volume supply."
      },
      {
        question: "What thickness should I choose?",
        answer: "We guide you based on the product weight, sharpness, and storage conditions."
      },
      {
...
HeroText:"From unique silhouettes to durable structure, our Shaped Pouches provide a modern, memorable, and reliable packaging solution for any product type.",
    ...
    About: {
      Title: "Shaped Pouch – Creative, Custom Packaging That Stands Out Instantly",
      Description:
  ...
  },
  {
    ...
    items: [
      ...
      Points: [
        ...
        "Strong laminated films and cutting accuracy",
        "High-quality printing and finishing",
        "Spout, zipper, window, and specialty feature support",
        "Bulk and wholesale supply",
        "Fast delivery with consistent quality",
        "Designs tailored to product and weight",
        "Food-safe and export-grade laminates"
      ],
      ClosingLine:
   ...
   FAQs: [
      ...
      {
        question: "Do jar shaped pouches look like real jars?",
        answer: "Yes, they often use transparent films to mimic glass jars."
      },
      {
        question: " Can you print full graphics on shaped pouches?",
        answer: "Yes, full custom printing is available."
      },
      {
        question: "What is the minimum order quantity?",
  ...
  },
  {
   ...
   FAQs: [
      ...
      },
      {
        ...
        answer: "Yes, we provide bulk and wholesale supply to brands & distributors."
      },
      {
        question: "Can spout pouches hold hot-fill products?",
        answer: "Yes, material can be selected based on hot-fill requirements."
      },
      {
...
HeroText:"Our Laminated Roll-Stock delivers the strength, versatility, and customizability you need to produce pouches, sachets, or wraps that fit your brand perfectly.",
    ...
    About: {
      Title: "Laminated Roll Stock – High-Strength, Customizable Packaging Material for Automated Production",
      Description:
  ...
  Conclusion:
   ...
   FAQs: [
      ...
      },
      {
        ...
        answer: "Yes, full-color custom printing is available."
      },
      {
        question: "Can I use laminated roll stock for liquid products?",
        answer: "Yes, with the right lamination structure, it supports liquids and gels."
      },
      {
        question: "Do you supply in bulk?",
...
HeroText:"From retail to industrial use, our Poly Bags deliver cost-effective protection and clean presentation for products of all shapes and sizes.",
    ...
    About: {
      Title: "Poly Bag – Lightweight, Durable & Cost-Efficient Packaging for All Industries",
      Description:
  ...
  Conclusion:
   ...
   FAQs: [
      ...
      },
      {
        ...
        answer: "Yes, we offer high-quality printing options."
      },
      {
...
HeroText:"Designed for banks, logistics, and retail industries, our Security Bags feature high-strength materials and advanced sealing technology for unmatched safety.",
    ...
    About: {
      Title: "Security Bag – Tamper-Evident Packaging for Safe Transport & Secure Storage",
      Description:
  ...
  Conclusion:
    ...
    Industry: [
    ...
    },
     {
      ...
      Points: [
        ...
        "Top-grade tamper-evident seals",
        "Customized bag sizes and features",
        "Sequential numbering and barcode printing",
        "Fast production and delivery",
        "Bulk and wholesale supply",
        "Bags compliant with industry safety standards",
        "Clear printing and durable finish"
      ],
      ClosingLine:
   ...
   FAQs: [
      ...
      {
        question: "Are these bags suitable for cash handling?",
        answer: "Yes, we manufacture strong, opaque, tamper-evident cash bags."
      },
      {
        question: "Do you offer secure evidence bags for police use?",
        answer: "Yes, with chain-of-custody panels."
      },
      {
        question: "Do you supply in bulk?",
...
HeroText:"Our eco-conscious Ziplock Poly Bags are designed for multiple uses — reducing waste while offering the strength and clarity your brand deserves.",
    ...
    About: {
      Title: "Small Ziplock Bags – Resealable, Reusable, and Perfect for Everyday & Industrial Use",
      Description:
  ...
  Conclusion:
    ...
    TypesManufactured: [
      {
        ...
        note: "These bags are especially helpful for organizing tiny items."
      },
      {
        name: "Standard Ziplock Bags",
        usedFor: ["Food storage", "Freezer-safe storage", "Cosmetics", "Office supplies"],
        note: "Everyday resealable bags for household and retail use."
      },
      {
        name: "Heavy-Duty Ziplock Bags",
        usedFor: ["Spare parts", "Machine components", "Tools", "Screws and bolts"],
        note: "Designed for industrial requirements and tougher handling."
      },
      {
        name: "Printed Ziplock Bags",
        usedFor: ["Branding", "Clear identification of contents"],
        note: "Used for branding and clear identification of contents."
      },
      {
        name: "Custom Ziplock Bags",
        usedFor: ["Retail packaging with logo", "Specific size or thickness requirements"],
        options: ["Size", "Thickness", "Zip style", "Printing", "Write-on panels"],
        note: "Fully tailored to your needs — perfect for retail brands needing packaging with their logo."
      },
      {
        name: "Personalized Ziplock Bags",
        usedFor: ["Private label branding", "Special messages", "Company logos", "Color-coded bags"],
        note: "Personalized ziplock bags work well for businesses that want unique brand-level packaging."
      }
    ],
    Personalized: {
      Title: "Personalization & Custom Options",
      Description:
    ...
    },
    {
      ...
      Points: [
        ...
        "Smooth and reliable ziplock closure",
        "Strong sealing and durable construction",
        "Custom and personalized printing",
        "Food-safe and industry-safe materials",
        "Bulk and wholesale supply",
        "Fast turnaround time",
        "Affordable pricing for small and large orders"
      ],
      ClosingLine:
   ...
   FAQs: [
      ...
      {
        question: "Can I get ziplock bags in different thicknesses?",
        answer: "Yes, thickness can be customized as needed."
      },
      {
        question: "Do you supply personalized ziplock bags for retail?",
        answer: "Yes, personalized bags are available for brands and stores."
      },
      {
